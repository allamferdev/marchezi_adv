      ...
      <section class="section section-lg bg-gray-800" id="clientes">
        <div class="container text-center text-xl-left">
          ...
          <div class="owl-carousel owl-carousel-4 text-center" data-items="1" data-sm-items="3" data-md-items="4" data-lg-items="5" data-xl-items="6" data-dots="true" data-nav="false" data-stage-padding="15" data-loop="false" data-margin="30" data-mouse-drag="false">
            <div class="item"><a class="link-image" ><img src="img/profiles/hugo-profile.jpeg" alt="" width="150" height="35"/></a>
            ...
            <div class="col-md-4">
              <div class="team-box-left">
                <div class="team-meta unit align-items-center">
                  <div class="unit-left"><img class="img" src="img/profiles/hugo-profile.jpeg" alt="" width="138" height="69"/>
                  </div>
                  <div class="unit-body">
                    <h5 class="title">Hugo Vasconcelos</h5>
  ...
  <section class="page-section" id="contatos">
   ...
   <footer class="section footer-classic">
        ...
        <div class="col-md-3 mb-4" align="center">
          <span class="copyright"><i class="far fa-envelope mr-1"></i>contato@hugocursos.com.br</span><br>
        ...
        <div class="col-md-6" align="center">
          <ul class="list-inline social-buttons">
            ...
            <li class="list-inline-item">
              <a href="https://www.facebook.com/hugo.vasconcelos.940" target="_blank" title="Nossa Página no Facebbok">
                <i class="fab fa-facebook-f"></i>
              </a>
            </li>
            <li class="list-inline-item">
               <a href="https://www.instagram.com/qcursos_network/" target="_blank" title="Nosso Instragram">
        ...
        <div class="col-md-3" align="center">
          <ul class="list-inline">
            ...
            <li class="list-inline-item">
              Hugo Vasconcelos - <a class="text-muted" href="http://api.whatsapp.com/send?1=pt_BR&phone=5531975275084" alt="31 97527-5084" target="_blank"><i class="fab fa-whatsapp mr-1"></i>31 97527-5084</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="footer-inner-2">
          <div class="container">
            <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span>. Todos os Direitos Reservados. Desenvolvido por <a href="https://www.hugocursos.com.br">Hugo Vasconcelos</a></p>
          </div>
        </div>
      </footer>
